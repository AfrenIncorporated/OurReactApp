...
import ClientJob from './ClientJob.jsx';
...
const endpoint3 = "https://afren-main-server.onrender.com/api/getClientGigs"
const endPoint4 = "https://afren-main-server.onrender.com/api/createProject"
...
export default function Client() {
    ...
    async function createProject(id){
        try{
            const response = await axios.post(endPoint4, {
                gigId : id
            }, {
                headers : {
                    Authorization : token
  ...
  return (
    <>
        ...
        <div id="fifth">
            ...
            :  isVisibleSection === "myjobs"
            ? <ClientJob 
                gigModal={gigModal}
                setGigModal={SetGigModal} 
        ...
        }
        {
            gigModal
            &&
            <div className='gig-modal-contanier'>
                
                <div className='gig-modal'>
                    <span onClick={()=>SetGigModal(false)}>x</span>
                    <p className='gigt-tites'>list of Gigs</p>
                    <ul className='gig-list'>
                        {
                            clientProjects.gigs.map((project,index)=>{
                                return (
                                    <li 
                                        onClick={()=>createProject(project.id)} 
                                        key={index}
                                    >
                                        {project.title}
                                    </li>
